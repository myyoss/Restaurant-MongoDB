...
function handleAdd(ev) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        price = price.value;
        img = img.value;
        const { data } = yield axios.post("/add-product", {
            category,
            name,
            price,
            img,
...
function handleUpdatePrice(ev, productId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { data } = yield axios.patch("/update-product-price", {
            productId,
            price,
        });
        loadPage(ev);
...
function handleUpdateName(ev, productId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { data } = yield axios.patch("/update-product-name", {
            productId,
            name,
        });
        loadPage(ev);
...
function handleDelete(productId) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data } = yield axios.delete("/delete-product", {
            data: { productId },
        });
        this.handleGetAllProducts();
    });
